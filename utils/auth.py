...
import bcrypt
from utils.db import create_user, get_user_by_email, init_db
...
def render_auth_page():
    ...
    .stApp { background: linear-gradient(135deg, #1A1A2E 0%, #16213E 50%, #0F3460 100%); font-family: 'DM Sans', sans-serif; }
    ...
    .auth-logo { font-family: 'Space Mono', monospace; color: #FF6B35; font-size: 2rem; text-align: center; margin-bottom: 4px; }
    .auth-sub  { color: #8D99AE; font-size: 0.9rem; text-align: center; margin-bottom: 28px; }
    .stTextInput label { color: #8D99AE !important; font-size: 0.85rem !important; }
    .stTextInput > div > div > input { background: #0F3460 !important; color: white !important; border: 1px solid rgba(255,255,255,0.1) !important; border-radius: 10px !important; }
    .stButton > button { background: linear-gradient(135deg, #FF6B35, #E85A2A) !important; color: white !important; border: none !important; border-radius: 10px !important; font-weight: 600 !important; width: 100% !important; padding: 10px !important; }
    </style>
